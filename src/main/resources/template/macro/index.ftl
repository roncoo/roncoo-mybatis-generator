...
<title>龙果学院-运营后台</title>
<meta name="Keywords" content="龙果学院,运营后台" />
<meta name="Description" content="龙果学院,运营后台" />
	...
	<div id="bjui-window">
		<header id="bjui-header">
			<div class="bjui-navbar-header">
				...
				<span class="bjui-navbar-logo" style="color:#fff;"><h4>龙果学院-运营后台</h4></span>
			</div>
				...
				<ul class="bjui-navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="${base}/admin/system/user/password" data-toggle="dialog" data-id="changepwd_page" data-mask="true" data-width="400" data-height="260">
				...
				<div class="tabsPageHeader">
					<div class="tabsPageHeaderContent">
						<ul class="navtab-tab nav nav-tabs">
							<li data-url="${base}/admin/index/content">
								<a href="javascript:;">
