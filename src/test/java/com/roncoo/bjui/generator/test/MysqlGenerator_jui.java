...
//				}
		...
		list.add(new FileOutConfig("/template/jui_ftl/list.ftl.vm") {
			// 自定义输出文件目录
			@Override
			public String outputFile(TableInfo tableInfo) {
		...
		list.add(new FileOutConfig("/template/jui_ftl/add.ftl.vm") {
			// 自定义输出文件目录
			@Override
			public String outputFile(TableInfo tableInfo) {
		...
		list.add(new FileOutConfig("/template/jui_ftl/edit.ftl.vm") {
			// 自定义输出文件目录
			@Override
			public String outputFile(TableInfo tableInfo) {
		...
		list.add(new FileOutConfig("/template/jui_ftl/view.ftl.vm") {
			// 自定义输出文件目录
			@Override
			public String outputFile(TableInfo tableInfo) {
